      ...
      <div class="panel"><div class="subhead">C · Salary basis → full pay</div>
        ...
        <div id="mat_basisC">
          ...
          <div id="mat_actualRow" style="display:${(c.full_pay_basis==="Actual")?'block':'none'};">
            ...
            <div id="mat_attBox" style="margin-top:8px;">${c.actual_avg_days?matAttSummaryHtml(c.attendance,c.actual_avg_days,c.days_per_month||26):'<div class="psub">Pulls the 6 completed months before the delivery month — present days (capped at a full month) net of late/undertime — for her true average.</div>'}</div>
          </div>
        </div>
      </div>
