...
function renderMovements(){
  ...
  pg.innerHTML=`
    <div class="panel" style="margin-top:0;">
      ...
      ${mvCatLine?`<div class="psub" style="margin:2px 0 6px;padding:8px 12px;background:#f4f7f5;border:1px solid #e2ebe5;border-radius:9px;"><b>By group:</b> ${mvCatLine} &nbsp;·&nbsp; <b>${Object.values(mvCatCounts).reduce((a,b)=>a+b,0)}</b> total &nbsp;·&nbsp; 📧 <b>${emailN}</b>/${payN.length} have a staff email${emailN<payN.length?` <span style="color:#9a6a00;">(${payN.length-emailN} to add — open the NPA to enter it)</span>`:" — all set for auto-email"}</div>`:""}
