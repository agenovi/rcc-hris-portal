...
function renderMovements(){
  ...
  pg.innerHTML=`
    <div class="panel" style="margin-top:0;">
      ...
      <div class="actionbar">
        ...
        ${mvMineStat.length?`<button class="btn" id="mvSignAll">✍ Sign all (as you) · ${mvMineStat.length}</button>`:""}
  ...
  const bSA=$("#mvSignAll"); if(bSA) bSA.addEventListener("click",()=>mvBatchSign(mvMineStat));
...
function mvBatchSign(list){
  ...
  m.innerHTML=`<div style="background:#fff;border-radius:14px;max-width:520px;width:100%;max-height:92vh;overflow-y:auto;padding:22px;">
    ...
    <div style="display:flex;gap:8px;align-items:center;margin-top:6px;flex-wrap:wrap;">
      ...
      <span id="mvBMsg" style="font-size:12.5px;color:#a4322a;flex:1;"></span>
    </div>
    <div style="display:flex;gap:10px;margin-top:14px;">
