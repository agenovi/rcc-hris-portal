...
const IDS_EDITOR="hr2@hassarams.com";  // Vina — sole bank/gov data-entry person
function canEditIds(){ const e=((CURRENT_USER&&CURRENT_USER.email)||"").toLowerCase(); return isAdminUser()||e===IDS_EDITOR; }
...
function openForm(e){
  ...
  m.innerHTML=`<div style="background:#f1f4f2;width:100%;max-width:560px;height:100%;overflow-y:auto;box-shadow:-6px 0 30px rgba(0,0,0,.18);">
    ...
    <div style="padding:18px 22px 60px;">
      ...
      </div>`:canSeeIds()?`<div class="panel"><div class="subhead">Government numbers &amp; bank <span class="sh-note">view only — entered by Vina</span></div>
...
async function renderActivity(){
  ...
  pg.innerHTML=`
    ...
    <div class="panel">
      ...
      <div class="psub" style="margin-top:9px;">🔓 Government IDs (SSS/PhilHealth/Pag-IBIG/TIN) &amp; bank details are <b>viewable by all HR</b> — needed for onboarding &amp; enrolment — but <b>entered/edited by Vina only</b> (single source of truth; you &amp; Sanjay can override). Everyone else sees them read-only. <b>Salary</b> stays restricted to you, Sanjay &amp; Grazel. Every bank/gov edit is logged below.</div>
    </div>
    <div class="panel">
