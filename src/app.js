...
function phBodyPool(){
  ...
  $("#phBody").innerHTML=`
    <div class="panel" style="margin-top:14px;">
      ...
      <div class="psub">Qualified applicants we liked but didn't proceed with — kept warm for future vacancies and replacements, so we can fill a slot without restarting recruitment. Ranked by priority, newest first. Set a candidate's priority &amp; salary scale when you move them here (any candidate → open → <b>Move to Talent Pool</b>).</div>
      ${all.length===0
